...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-gray-100 flex flex-col">
      {/* Header */}
      <header className="header-dark backdrop-blur-sm flex-shrink-0 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          {/* Logo */}
          <Link to="/" className="flex items-center gap-2">
            
            <span className="text-white text-xl font-semibold">taskify®</span>
          </Link>
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            >
              <button className="text-white flex items-center gap-1 transition-colors py-2">
                Jobs
              ...
              {isJobsOpen && (
                <div className="absolute top-full left-0 pt-1 z-50">
                  <div className="w-48 bg-black rounded-lg shadow-lg border border-gray-200 py-2">
                    <a
                      href="#find-job"
            ...
            <Link to="/contact" className="text-white font-medium transition-colors">Contact</Link>
          </nav>
  ...
  <div className="contact-split">
    ...
    <div className="contact-right">
      ...
      {/* Footer */}
      <footer className="landing-footer" style={{ backgroundColor: '#0f0e0e' }}>
